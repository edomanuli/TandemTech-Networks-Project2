...
namespace Service
{
    public class ServiceManager : IServiceManager
    {
        ...
        private readonly Lazy<IInfoService> _infoService;
        ...
        public ServiceManager(IRepositoryManager repositoryManager, ILoggerManager logger, IMapper mapper, UserManager<User> userManager, IConfiguration configuration)
        {
            ...
            _infoService = new Lazy<IInfoService>(() => new InfoService(repositoryManager, logger, mapper));
        ...
        public IInfoService Info => _infoService.Value;
